...
force force kat_pharma_allowStackScript_EACA = false;
force force kat_pharma_allowStackScript_TXA = false;
force force kat_pharma_bandageCycleTime_EACA = 20;
...
force force kat_pharma_coagulation_time_large = 60;
force force kat_pharma_coagulation_time_medium = 30;
force force kat_pharma_coagulation_time_minor = 17;
...
force force kat_pharma_treatmentTime_ApplyIO = 1.98565;
force force kat_pharma_treatmentTime_ApplyIV = 7;
force force kat_pharma_treatmentTime_Atropine = 7;
force force kat_pharma_treatmentTime_Carbonate = 6;
