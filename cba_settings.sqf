...
force ace_fortify_timeCostCoefficient = 0.14;
...
force ace_cargo_unloadOnKilled = 0.7;
...
force force ace_medical_fractureChance = 0.55;
force force ace_medical_fractures = 1;
force force ace_medical_ivFlowRate = 2.0;
force force ace_medical_limbDamageThreshold = 3;
force force ace_medical_limping = 0;
force force ace_medical_painCoefficient = 1.17;
force force ace_medical_painUnconsciousChance = 0.14;
...
force ace_medical_treatment_timeCoefficientPAK = 2.5;
...
force ace_medical_treatment_treatmentTimeIV = 6;
force ace_medical_treatment_treatmentTimeSplint = 5;
force ace_medical_treatment_treatmentTimeTourniquet = 5;
force ace_medical_treatment_treatmentTimeTrainedAutoinjector = 3;
force ace_medical_treatment_treatmentTimeTrainedIV = 3;
force ace_medical_treatment_treatmentTimeTrainedSplint = 3;
force ace_medical_treatment_treatmentTimeTrainedTourniquet = 3;
...
force force ace_repair_patchWheelTime = 2;
...
force force crowsEW_spectrum_defaultClassForJammingSignal = "UGV_01_base_F,UGV_02_Base_F,UAV_01_base_F,UAV_02_base_F,UAV_03_base_F,UAV_04_base_F,UAV_05_Base_F,UAV_06_base_F,GX_HONEYBADGER_UGV_BASE,GX_BLACK_HORNET_UAV_BASE,GX_DRONE40_UAV_BASE,shahed_base_F,UAV_02_Base_lxWS,GX_MAGURA_V5_USV_BASE,GX_THEMIS_UGV_BASE,GX_RWS_DEFNDER_MEDIUM_BASE,GX_HUNTER_SP_UAV_BASE,GX_RQ11B_UAV_BASE";
force force crowsEW_spectrum_defaultRangesForJammingSignal = "400,400,400,600,400,600,600,600,400,400,400,800,400,400,400,400,600,400";
...
force TCL_Setting_AI_AdditionalDistance = 1000;
force TCL_Setting_AI_AdditionalJoin = true;
force TCL_Setting_AI_AdditionalKnowledge = 2.28994;
force TCL_Setting_AI_AdditionalRequest = true;
force TCL_Setting_AI_AlertZoneRadius = 300;
force TCL_Setting_AI_Courage = 0.15;
force TCL_Setting_AI_DisableMove = false;
force TCL_Setting_AI_DisableReinf = false;
force TCL_Setting_AI_ForgetBase = 15;
force TCL_Setting_AI_ForgetEnabled = true;
force TCL_Setting_AI_ForgetRandom = 10;
force TCL_Setting_AI_MaxDetectRange = 1500;
force TCL_Setting_AI_NightMultiplier = 0.3;
force TCL_Setting_AI_NightWeatherEnabled = true;
force TCL_Setting_AI_Regroup = true;
force TCL_Setting_AI_ReinfKnowledge = 1.28558;
force TCL_Setting_AI_ReinfLimit = 10.2875;
force TCL_Setting_AI_SoundAlertAllGroups = false;
force TCL_Setting_AI_SoundEnabled = true;
force TCL_Setting_AI_SoundRadius = 1000;
force TCL_Setting_AI_SoundRadiusSuppressed = 100;
force TCL_Setting_AI_StanceControl = 0;
force TCL_Setting_AI_SuppressorEnabled = true;
force TCL_Setting_AI_Synchronize = true;
force TCL_Setting_AI_Timeout = 300;
force TCL_Setting_Debug_Cursor = false;
force TCL_Setting_Debug_Marker1 = true;
force TCL_Setting_Debug_Marker2 = true;
force TCL_Setting_Debug_Marker3 = true;
force TCL_Setting_Debug_Mission = true;
force TCL_Setting_Debug_System = true;
force TCL_Setting_DynSim_AirEnabled = false;
force TCL_Setting_DynSim_BLUFOR = false;
force TCL_Setting_DynSim_CIV = false;
force TCL_Setting_DynSim_DistAir = 5000;
force TCL_Setting_DynSim_DistInfantry = 2500;
force TCL_Setting_DynSim_DistVehicle = 2500;
force TCL_Setting_DynSim_Enabled = false;
force TCL_Setting_DynSim_INDEP = false;
force TCL_Setting_DynSim_InfantryEnabled = false;
force TCL_Setting_DynSim_Interval = 20;
force TCL_Setting_DynSim_OPFOR = false;
force TCL_Setting_DynSim_VehicleEnabled = false;
force TCL_Setting_Feat_Advancing = true;
force TCL_Setting_Feat_AdvancingChance = 70;
force TCL_Setting_Feat_AntiClip = true;
force TCL_Setting_Feat_Artillery = false;
force TCL_Setting_Feat_ArtilleryChance = 0;
force TCL_Setting_Feat_CQB = true;
force TCL_Setting_Feat_CQBCooldown = 60;
force TCL_Setting_Feat_CQBDistance = 250;
force TCL_Setting_Feat_CQBMaxUnits = 5;
force TCL_Setting_Feat_CQBMinUnits = 1;
force TCL_Setting_Feat_DangerAssessment = true;
force TCL_Setting_Feat_Dodge = true;
force TCL_Setting_Feat_DodgeCooldown = 3;
force TCL_Setting_Feat_DodgePlayerTeam = false;
force TCL_Setting_Feat_Flanking = true;
force TCL_Setting_Feat_FlankingChance = 70;
force TCL_Setting_Feat_Flare = true;
force TCL_Setting_Feat_FlareChance = 50;
force TCL_Setting_Feat_Garrison = true;
force TCL_Setting_Feat_Heal = false;
force TCL_Setting_Feat_HealChance = 0;
force TCL_Setting_Feat_HouseSearch = true;
force TCL_Setting_Feat_HouseSearchChance = 50;
force TCL_Setting_Feat_Rearm = false;
force TCL_Setting_Feat_RearmChance = 0;
force TCL_Setting_Feat_Smoke = true;
force TCL_Setting_Feat_SmokeChance = 50;
force TCL_Setting_Feat_SmokeVehicle = true;
force TCL_Setting_Feat_SmokeVehicleChance = 75;
force TCL_Setting_Feat_StaticWeapon = true;
force TCL_Setting_Feat_StaticWeaponChance = 50;
force TCL_Setting_Feat_Suppressed = true;
force TCL_Setting_Feat_Surrender = false;
force TCL_Setting_Feat_SurrenderChance = 0;
force TCL_Setting_Feat_TakeCover = true;
force TCL_Setting_Feat_TakeCoverChance = 70;
force TCL_Setting_Feat_TankFlee = true;
force TCL_Setting_Feat_TankFleeDistance = 300;
force TCL_Setting_Feat_TankRotate = true;
force TCL_Setting_Feat_TankRotateThreshold = 30;
force TCL_Setting_Feat_Watch = true;
force TCL_Setting_Feat_WatchChance = 60;
force TCL_Setting_Player_AllowOverride = false;
force TCL_Setting_Player_ApplyTCL = false;
force TCL_Setting_System_AI = true;
force TCL_Setting_System_CombatAIvsAI = true;
force TCL_Setting_System_Delay = 0;
force TCL_Setting_System_FX = true;
force TCL_Setting_System_GetIn = true;
force TCL_Setting_System_InitBatchDelay = 0;
force TCL_Setting_System_InitBatchSize = 0;
force TCL_Setting_System_Respawn = false;
force TCL_Setting_System_Skill = true;
force TCL_Setting_System_SkillDivider = 2;
force TCL_Setting_System_Spawn = true;
force TCL_Setting_System_SpawnDelay = 0;
force TCL_Setting_Tweak_PushChance = 60;
force TCL_Setting_Tweak_PushDistance = 300;
force TCL_Setting_Tweak_SearchRadius = 200;
...
// GAIT
force force GAIT_ss_aceAcidosisPenaltyFactor = 0.45;
force force GAIT_ss_aceBridgeEnabled = true;
force force GAIT_ss_aceMuscleDamagePenaltyFactor = 0.25;
force force GAIT_ss_audioFadeLerp = 0.08;
force force GAIT_ss_audioStopExhaustion = 0.1;
force force GAIT_ss_braceMinReserveRatio = 0.98;
force force GAIT_ss_braceNoMomentumThreshold = 0.04;
force force GAIT_ss_braceReadySpeedThreshold = 4;
force force GAIT_ss_braceRecentSprintCooldown = 3;
force force GAIT_ss_braceRequiredWalkTime = 2;
force force GAIT_ss_carrySprintExhaustedSpeed = 0.9;
force force GAIT_ss_carrySprintFullSpeed = 1.5;
force force GAIT_ss_carryWalkSpeed = 0.8;
force force GAIT_ss_clearAceMovementLocks = true;
force force GAIT_ss_compatibilityMode = 1;
force force GAIT_ss_debugHudEnabled = false;
force force GAIT_ss_debugHudInterval = 0.1;
force force GAIT_ss_downhillBoostEnabled = true;
force force GAIT_ss_downhillBoostMaxDegrees = 18;
force force GAIT_ss_downhillBoostStartDegrees = 4;
force force GAIT_ss_downhillGravityGainKmhPerSecond = 2.2;
force force GAIT_ss_downhillGravityMaxBonusKmh = 14;
force force GAIT_ss_downhillGroundAdhesionEnabled = true;
force force GAIT_ss_downhillGroundAdhesionEndDegrees = 34;
force force GAIT_ss_downhillGroundAdhesionExperimentalEnabled = false;
force force GAIT_ss_downhillGroundAdhesionMaxGroundGap = 0.35;
force force GAIT_ss_downhillGroundAdhesionMinGroundGap = 0.08;
force force GAIT_ss_downhillGroundAdhesionMinSpeedKmh = 12;
force force GAIT_ss_downhillGroundAdhesionStartDegrees = 24;
force force GAIT_ss_downhillGroundAdhesionStrengthMS = 0.18;
force force GAIT_ss_downhillMaxBoost = 0.06;
force force GAIT_ss_downhillMaxSpeedMultiplier = 1.8;
force force GAIT_ss_downhillMomentumEasyTriggerDegrees = 10;
force force GAIT_ss_downhillTripBaseChancePerSecond = 0.005;
force force GAIT_ss_downhillTripCooldown = 10;
force force GAIT_ss_downhillTripDuration = 1;
force force GAIT_ss_downhillTripEnabled = true;
force force GAIT_ss_downhillTripGetUpSpeedKmh = 7;
force force GAIT_ss_downhillTripMaxChancePerSecond = 0.1;
force force GAIT_ss_downhillTripMaxDegrees = 45;
force force GAIT_ss_downhillTripMaxRagdollDuration = 6;
force force GAIT_ss_downhillTripMinSpeedKmh = 20;
force force GAIT_ss_downhillTripMinSprintSeconds = 5;
force force GAIT_ss_downhillTripPostFallImmunity = 10;
force force GAIT_ss_downhillTripRequireSustainedMovement = true;
force force GAIT_ss_downhillTripSpeedInfluence = 1;
force force GAIT_ss_downhillTripSpeedMaxKmh = 34;
force force GAIT_ss_downhillTripSustainedSpeedKmh = 20;
force force GAIT_ss_downhillTripSustainedSpeedSeconds = 4;
force force GAIT_ss_downhillTripThresholdDegrees = 28;
force force GAIT_ss_downhillTripWeightInfluence = 1;
force force GAIT_ss_enabled = true;
force force GAIT_ss_exhaustedFatigue = 0.85;
force force GAIT_ss_experimentalSlopeAnimationForcing = false;
force force GAIT_ss_fatigueMomentumCouplingEnabled = true;
force force GAIT_ss_fatigueMomentumRampPenalty = 0.45;
force force GAIT_ss_freshFatigue = 0.05;
force force GAIT_ss_fxChromAberration = 0.007;
force force GAIT_ss_fxCommitTime = 0.15;
force force GAIT_ss_fxContrastBoost = 0.24;
force force GAIT_ss_fxDynamicBlur = 0.065;
force force GAIT_ss_fxRadialBlur = 0.06;
force force GAIT_ss_fxScreenDim = 0.12;
force force GAIT_ss_fxWhiteFade = 0.34;
force force GAIT_ss_hardLandingCamShakeEnabled = true;
force force GAIT_ss_hardLandingMinVerticalSpeed = 4;
force force GAIT_ss_hardLandingShakeStrength = 1;
force force GAIT_ss_hearingEnabled = true;
force force GAIT_ss_hearingFadeDuration = 0.2;
force force GAIT_ss_hearingMinVolume = 0.2;
force force GAIT_ss_heavyBraceRelief = 0;
force force GAIT_ss_heavySpeedBonus = 1;
force force GAIT_ss_hillStartDownhillMaxDuration = 3.2;
force force GAIT_ss_hillStartDownhillMinDuration = 1.2;
force force GAIT_ss_hillStartHighMomentumSpeedKmh = 18;
force force GAIT_ss_hillStartMomentumGateCurve = 1.85;
force force GAIT_ss_hillStartMomentumGateEnabled = false;
force force GAIT_ss_hillStartMomentumGateMaxDegrees = 40;
force force GAIT_ss_hillStartMomentumGateStartDegrees = 15;
force force GAIT_ss_hillStartUphillMaxDuration = 5.6;
force force GAIT_ss_hillStartUphillMinDuration = 2.4;
force force GAIT_ss_hillStartWeightInfluence = 0.85;
force force GAIT_ss_hillWalkDownhillMaxPenalty = 0.08;
force force GAIT_ss_hillWalkSlowdownEnabled = true;
force force GAIT_ss_hillWalkSlowdownMaxDegrees = 40;
force force GAIT_ss_hillWalkSlowdownStartDegrees = 15;
force force GAIT_ss_hillWalkUphillMaxPenalty = 0.32;
force force GAIT_ss_lightBraceRelief = 0.55;
force force GAIT_ss_lightSpeedBonus = 1.08;
force force GAIT_ss_lightWeightMax = 35;
force force GAIT_ss_loadAbsPerLb = 10;
force force GAIT_ss_masterFxIntensity = 1;
force force GAIT_ss_masterMomentumStrength = 1;
force force GAIT_ss_masterSlopeSeverity = 1;
force force GAIT_ss_masterTripFrequency = 1;
force force GAIT_ss_masterWeightSeverity = 1;
force force GAIT_ss_mediumBraceRelief = 0.35;
force force GAIT_ss_mediumSpeedBonus = 1.05;
force force GAIT_ss_mediumWeightMax = 55;
force force GAIT_ss_moderateBraceRelief = 0.18;
force force GAIT_ss_moderateSpeedBonus = 1.025;
force force GAIT_ss_moderateWeightMax = 75;
force force GAIT_ss_noJitterSlopeVisualMode = false;
force force GAIT_ss_noJitterVelocityIsolation = false;
force force GAIT_ss_normalSpeed = 0.86;
force force GAIT_ss_preset = "Balanced";
force force GAIT_ss_registerAceAnimExclusion = true;
force force GAIT_ss_resetOnRespawn = true;
force force GAIT_ss_restingAimCoef = 0.02;
force force GAIT_ss_rptLogging = true;
force force GAIT_ss_runningAimCoef = 2;
force force GAIT_ss_shiftReleaseRealVelocityCarryEnabled = false;
force force GAIT_ss_shiftReleaseRunTaperCurve = 1.45;
force force GAIT_ss_shiftReleaseRunTaperDuration = 0.85;
force force GAIT_ss_shiftReleaseRunTaperEnabled = true;
force force GAIT_ss_shiftReleaseRunTaperHoldDuration = 1;
force force GAIT_ss_shiftReleaseRunTaperVelocityCarryEnabled = true;
force force GAIT_ss_shiftSlopeEaseDuration = 1.4;
force force GAIT_ss_showServerIndicator = true;
force force GAIT_ss_showStartupMessage = true;
force force GAIT_ss_slopeAngleFallRateDegPerSecond = 30;
force force GAIT_ss_slopeAngleRiseRateDegPerSecond = 22;
force force GAIT_ss_slopeAnimSpeedCompDownhillTargetKmh = 16;
force force GAIT_ss_slopeAnimSpeedCompensationEnabled = false;
force force GAIT_ss_slopeAnimSpeedCompMaxCoef = 1.35;
force force GAIT_ss_slopeAnimSpeedCompSmoothness = 0.65;
force force GAIT_ss_slopeAnimSpeedCompStartDegrees = 12;
force force GAIT_ss_slopeAnimSpeedCompUphillTargetKmh = 15;
force force GAIT_ss_slopeHandlingEnabled = true;
force force GAIT_ss_slopeMomentumMaxDegrees = 35;
force force GAIT_ss_slopeMomentumModelEnabled = true;
force force GAIT_ss_slopeMomentumStartDegrees = 15;
force force GAIT_ss_slopeSampleDistance = 2;
force force GAIT_ss_slopeSprintGuaranteeEnabled = true;
force force GAIT_ss_slopeSprintGuaranteeStartDegrees = 4;
force force GAIT_ss_slopeSprintTemporaryStaminaDisable = false;
force force GAIT_ss_slopeSprintVisualLockEnabled = true;
force force GAIT_ss_slopeSprintVisualLockRefresh = 0.3;
force force GAIT_ss_slopeSprintVisualLockStartDegrees = 12;
force force GAIT_ss_slopeSprintVisualLockUseImmediate = false;
force force GAIT_ss_slopeSprintVisualRescueCooldown = 0.5;
force force GAIT_ss_slopeSprintVisualRescueEnabled = true;
force force GAIT_ss_slopeSprintVisualRescueMinFalloutTime = 0.15;
force force GAIT_ss_slopeSprintVisualRescueStartDegrees = 6;
force force GAIT_ss_slopeSprintVisualRescueUseImmediate = true;
force force GAIT_ss_slopeStopBraceEnabled = true;
force force GAIT_ss_slopeStopBraceExtraDip = 0.28;
force force GAIT_ss_slopeStopBraceExtraDuration = 0.18;
force force GAIT_ss_slopeStopBraceMaxDegrees = 35;
force force GAIT_ss_slopeStopBraceMemoryTime = 2.5;
force force GAIT_ss_slopeStopBraceStartDegrees = 15;
force force GAIT_ss_slopeStrafeAssistDownhillStrength = 1;
force force GAIT_ss_slopeStrafeAssistEnabled = true;
force force GAIT_ss_slopeStrafeAssistMaxLateralKmh = 9;
force force GAIT_ss_slopeStrafeAssistSmoothness = 0.5;
force force GAIT_ss_slopeStrafeAssistStartDegrees = 4;
force force GAIT_ss_slopeStrafeAssistUphillStrength = 1.1;
force force GAIT_ss_slopeStrafeVelocityAssistExperimental = true;
force force GAIT_ss_slopeTransitionSmoothingEnabled = true;
force force GAIT_ss_slopeVelocityAssistDownhillFloorKmh = 15;
force force GAIT_ss_slopeVelocityAssistEnabled = false;
force force GAIT_ss_slopeVelocityAssistMaxNudgeKmh = 4;
force force GAIT_ss_slopeVelocityAssistStartDegrees = 14;
force force GAIT_ss_slopeVelocityAssistStrength = 0.65;
force force GAIT_ss_slopeVelocityAssistTargetScale = 0.94;
force force GAIT_ss_slopeVelocityAssistUphillFloorKmh = 14;
force force GAIT_ss_slopeVelocityDirectionSmoothness = 0.18;
force force GAIT_ss_slopeVelocityMouseFlingGuardDot = 0.35;
force force GAIT_ss_slopeVelocityRampBaseDuration = 1.05;
force force GAIT_ss_slopeVelocityRampCurve = 1.55;
force force GAIT_ss_slopeVelocityRampEnabled = true;
force force GAIT_ss_slopeVelocityRampSlopeInfluence = 0.65;
force force GAIT_ss_slopeVelocityTargetFallRateKmhPerSecond = 8;
force force GAIT_ss_slopeVelocityTargetMinTransitionSeconds = 1;
force force GAIT_ss_slopeVelocityTargetRiseRateKmhPerSecond = 5.5;
force force GAIT_ss_slopeVelocityTurnCapDegPerSecond = 100;
force force GAIT_ss_slopeVelocityTurnCapEnabled = true;
force force GAIT_ss_slopeVelocityTurnCutDuration = 0.3;
force force GAIT_ss_slopeVelocityTurnHardCutAngle = 32;
force force GAIT_ss_slopeVelocityUseStableDirection = true;
force force GAIT_ss_speedLerp = 0.05;
force force GAIT_ss_sprintExhaustedSpeed = 0.89;
force force GAIT_ss_sprintFullSpeed = 1.28;
force force GAIT_ss_sprintRecoverTime = 10;
force force GAIT_ss_sprintReserveMax = 25;
force force GAIT_ss_sprintStartBraceDuration = 0.15;
force force GAIT_ss_sprintStartBraceEnabled = true;
force force GAIT_ss_sprintStartBraceLerp = 0.575;
force force GAIT_ss_sprintStartBraceSpeed = 0.42;
force force GAIT_ss_stairSmoothingEnabled = true;
force force GAIT_ss_surfaceTractionCoastInfluence = 0.2;
force force GAIT_ss_surfaceTractionEnabled = true;
force force GAIT_ss_surfaceTractionRampInfluence = 0.25;
force force GAIT_ss_suspendInSpectator = true;
force force GAIT_ss_suspendWhileUnconscious = true;
force force GAIT_ss_swayEnabled = true;
force force GAIT_ss_swayRecoveryTime = 6;
force force GAIT_ss_tickRate = 0.05;
force force GAIT_ss_tinnitusEnabled = true;
force force GAIT_ss_tinnitusMaxVolume = 0.55;
force force GAIT_ss_tinnitusStartExhaustion = 0.7;
force force GAIT_ss_tunnelMaxStrength = 1;
force force GAIT_ss_tunnelStartExhaustion = 0.18;
force force GAIT_ss_turnRateBleedMaxDegPerSecond = 240;
force force GAIT_ss_turnRateBleedMaxPerSecond = 0.18;
force force GAIT_ss_turnRateBleedStartDegPerSecond = 90;
force force GAIT_ss_turnRateMomentumBleedEnabled = true;
force force GAIT_ss_unarmedSprintNormalizer = 0.725;
force force GAIT_ss_uphillFatigueDrainEnabled = true;
force force GAIT_ss_uphillFatigueDrainMaxDegrees = 35;
force force GAIT_ss_uphillFatigueDrainMaxMultiplier = 1.75;
force force GAIT_ss_uphillFatigueDrainStartDegrees = 10;
force force GAIT_ss_uphillForceSprintOverride = true;
force force GAIT_ss_uphillHardSpeedCapKmh = 15;
force force GAIT_ss_uphillMaxDegrees = 35;
force force GAIT_ss_uphillMaxPenalty = 0.4;
force force GAIT_ss_uphillMinSprintMultiplier = 0.6;
force force GAIT_ss_uphillResistanceMaxLossKmh = 2;
force force GAIT_ss_uphillResistanceRampInfluence = 0.7;
force force GAIT_ss_uphillSlowdownEnabled = true;
force force GAIT_ss_uphillSprintAnimationMinDegrees = 5;
force force GAIT_ss_uphillSprintAnimationMinSpeedKmh = 3;
force force GAIT_ss_uphillSprintAnimationOverrideEnabled = false;
force force GAIT_ss_uphillSprintAnimationPulse = 1.25;
force force GAIT_ss_uphillStartDegrees = 5;
force force GAIT_ss_uphillVanillaFatigueExtraPerSecond = 0.018;
force force GAIT_ss_uphillVisualSpeedSyncEnabled = true;
force force GAIT_ss_uphillVisualSpeedSyncMinCoef = 0.58;
force force GAIT_ss_uphillVisualSpeedSyncStartDegrees = 15;
force force GAIT_ss_useAceReserveModel = true;
force force GAIT_ss_vanillaFatigueClamp = 0.55;
force force GAIT_ss_vegetationDragEnabled = true;
force force GAIT_ss_vegetationDragMax = 0.18;
force force GAIT_ss_vegetationDragRadius = 2.5;
force force GAIT_ss_velocityTurnCapDegPerSecond = 220;
force force GAIT_ss_visualFxEnabled = true;
force force GAIT_ss_walkingAimCoef = 0.01;
force force GAIT_ss_walkingSpeedThreshold = 0.6;
force force GAIT_ss_weightCoastMaxBonus = 0.25;
force force GAIT_ss_weightScaledCoastEnabled = true;
force force GAIT_ss_wReleaseForcedCoastCancelOnLateral = true;
force force GAIT_ss_wReleaseForcedCoastCurve = 1.75;
force force GAIT_ss_wReleaseForcedCoastDuration = 0.74;
force force GAIT_ss_wReleaseForcedCoastEnabled = true;
force force GAIT_ss_wReleaseForcedCoastEndScale = 0;
force force GAIT_ss_wReleaseForcedCoastMaxDuration = 0.9;
force force GAIT_ss_wReleaseForcedCoastMaxSampleAge = 0.35;
force force GAIT_ss_wReleaseForcedCoastMinDuration = 0.25;
force force GAIT_ss_wReleaseForcedCoastMinStartKmh = 8;
force force GAIT_ss_wReleaseForcedCoastReferenceKmh = 26;
force force GAIT_ss_wReleaseForcedCoastRequireMomentum = true;
force force GAIT_ss_wReleaseForcedCoastSlopeInfluence = 0.2;
force force GAIT_ss_wReleaseForcedCoastStopKmh = 1.75;
force force GAIT_ss_wReleaseForcedCoastVelocityScale = 0.92;
force force GAIT_ss_wReleaseLatchTime = 1;
force force GAIT_ss_wReleaseMomentumCaptureScale = 1;
force force GAIT_ss_wReleaseMomentumDuration = 1.5;
force force GAIT_ss_wReleaseMomentumEnabled = true;
force force GAIT_ss_wReleaseSpeedBasedCoastEnabled = true;
force force GAIT_ss_wReleaseZeroMomentumDelay = 0.5;
...
force kat_chemical_availCBRNUniform = "'U_C_CBRN_Suit_01_Blue_F','U_C_CBRN_Suit_01_White_F','U_B_CBRN_Suit_01_Wdl_F','U_B_CBRN_Suit_01_MTP_F','U_B_CBRN_Suit_01_Tropic_F','U_I_CBRN_Suit_01_AAF_F','U_I_E_CBRN_Suit_01_EAF_F','JCA_U_NBCD_Suit_01_black_F','JCA_U_NBCD_Suit_01_olive_F','JCA_U_NBCD_Suit_01_sand_F','JCA_U_NBCD_Suit_01_White_F','JCA_U_NBCD_Suit_01_Yellow_F','JCA_U_NBCD_Suit_01_hood_black_F','JCA_U_NBCD_Suit_01_hood_olive_F','JCA_U_NBCD_Suit_01_hood_sand_F','JCA_U_NBCD_Suit_01_hood_White_F','JCA_U_NBCD_Suit_01_hood_Yellow_F','taw_aux_customs_uniform_cbrn_nfp_t','taw_aux_customs_uniform_cbrn_flecktarn','taw_aux_customs_uniform_cbrn_marpat_d','taw_aux_customs_uniform_cbrn_m05_snow'";
...
force kat_chemical_chlorine_onsetTime = 30;
force kat_chemical_cloudIdMemoryTime = 30;
force kat_chemical_contaminationTickInterval = 40;
force kat_chemical_deconActionTime = 8;
...
force kat_chemical_m8PaperActionTime = 3;
force kat_chemical_m8PaperDisplayTime = 8;
force kat_chemical_maskStaminaLoss = false;
force kat_chemical_mustard_burnOnsetMax = 240;
force kat_chemical_mustard_burnOnsetMin = 100;
force kat_chemical_mustard_eyeOnsetMax = 100;
force kat_chemical_mustard_eyeOnsetMin = 40;
force kat_chemical_phosgene_onsetMax = 360;
force kat_chemical_phosgene_onsetMin = 120;
force kat_chemical_sarin_cardiacArrestTime = 100;
force kat_chemical_sarin_unconsciousTime = 65;
force kat_chemical_sarin_vomitTime = 30;
force kat_chemical_showPoisoning = true;
force kat_chemical_tearGasDropChance = 0;
force kat_chemical_vx_cardiacArrestTime = 240;
force kat_chemical_vx_cloudLifetime = 600;
force kat_chemical_vx_unconsciousTime = 120;
force kat_chemical_vx_vomitTime = 60;
...
force force kat_circulation_CPR_MaxChance_Doctor = 95;
force force kat_circulation_CPR_MaxChance_RegularMedic = 60;
force force kat_circulation_CPR_MinChance_Default = 20;
force force kat_circulation_CPR_MinChance_Doctor = 60;
...
force force force kat_ophthalmology_eyeshield_medic_required = 0;
force force kat_ophthalmology_eyeshield_treatment_time = 2;
force force kat_ophthalmology_eyewash_medic_required = 0;
force force force kat_ophthalmology_eyewash_treatment_time = 2;
...
force force kat_pharma_pervitinSpeed = 1;
...
// Reach
force force fluss_reach_debug = false;
force force fluss_reach_enabled = true;
force force fluss_reach_grenade_backpack = true;
force force fluss_reach_grenade_bocr = true;
force force fluss_reach_grenade_crate = true;
force force fluss_reach_grenade_enabled = true;
force force fluss_reach_grenade_groundRadius = 2;
force force fluss_reach_grenade_uniform = true;
force force fluss_reach_grenade_vehicle = true;
force force fluss_reach_grenade_vehicleRadius = 2;
force force fluss_reach_grenade_vest = true;
force force fluss_reach_interact_backpack = true;
force force fluss_reach_interact_bocr = true;
force force fluss_reach_interact_crate = true;
force force fluss_reach_interact_enabled = false;
force force fluss_reach_interact_groundRadius = 2;
force force fluss_reach_interact_uniform = true;
force force fluss_reach_interact_vehicle = true;
force force fluss_reach_interact_vehicleRadius = 2;
force force fluss_reach_interact_vest = true;
force force fluss_reach_mag_backpack = true;
force force fluss_reach_mag_bocr = true;
force force fluss_reach_mag_crate = true;
force force fluss_reach_mag_enabled = true;
force force fluss_reach_mag_groundRadius = 2;
force force fluss_reach_mag_priority_full = true;
force force fluss_reach_mag_uniform = true;
force force fluss_reach_mag_vehicle = true;
force force fluss_reach_mag_vehicleRadius = 2;
force force fluss_reach_mag_vest = true;
force force fluss_reach_med_backpack = true;
force force fluss_reach_med_bocr = true;
force force fluss_reach_med_crate = true;
force force fluss_reach_med_enabled = true;
force force fluss_reach_med_groundRadius = 2;
force force fluss_reach_med_uniform = true;
force force fluss_reach_med_vehicle = true;
...
force TAW_Supplies_List = "[[""TAW_Supplies_Barrel"",400],[""TAW_Supplies_Box"",300],[""TAW_Supplies_Ammo"",500],[""TAW_Supplies_Cash"",450],[""TAW_Supplies_Gold"",800]]";
force TAW_VehicleSpawner_Air_List = "[[""B_Plane_Fighter_01_F"",500],[""FIR_AV8B"",500],[""RHSGREF_A29B_HIDF"",300],[""USAF_A10"",600],[""JS_JC_FA18E"",525],[""JS_JC_FA18F"",525],[""USAF_F22"",550],[""USAF_F35A"",650],[""FIR_F16C"",550],[""FIR_F16D"",575],[""ua_haf_jas_39"",450],[""rhs_l159_cdf_b_CDF"",350],[""JK_B_US_C5M_Super_Galaxy_F"",700],[""JK_B_US_C5B_Galaxy_F"",700],[""JK_B_US_C5M_Super_Galaxy_F"",750],[""USAF_C130J"",600],[""STmod_airplane_AC130J"",800],[""STmod_airplane_MC130J"",600],[""STmod_airplane_MC130J_VIV"",600],[""RHS_UH60M_d"",225],[""B_Heli_Transport_01_F"",200],[""Heli_Transport_01_pylons_laser_base_mk2"",250],[""B_CTRG_Heli_Transport_01_Assault_F"",200],[""B_CTRG_Heli_Transport_01_DAP_F"",250],[""RHS_MELB_MH6M"",175],[""RHS_MELB_AH6M"",275],[""RHS_MELB_AH6M_MK2"",275],[""RHS_UH1Y"",200],[""rhsusf_CH53E_USMC"",350],[""TF373_SOAR_MH47G"",300],[""B_Heli_Transport_03_F"",300],[""RHS_AH64D"",600],[""O_Heli_Attack_02_dynamicLoadout_F"",600],[""B_Heli_Attack_01_pylons_dynamicLoadout_F"",400],[""RHS_AH1Z"",450],[""Valor_Turret_Transport_CrewGun_F"",350],[""Valor_Attack_F"",400],[""Valor_Transport_Armed_F"",275],[""B_T_VTOL_02_medical_dynamicLoadout_F"",300],[""B_T_VTOL_02_infantry_dynamicLoadout_F"",450],[""B_T_VTOL_02_vehicle_dynamicLoadout_F"",450],[""B_T_VTOL_01_infantry_F"",250],[""B_T_VTOL_01_vehicle_F"",250],[""B_T_VTOL_01_armed_F"",400],[""B_Heli_Transport_04_F"",200]]";
...
force TAW_VehicleSpawner_Car_List = "[[""rhsusf_m1151_m2_v1_usarmy_d"",175],[""rhsusf_m1240a1_m240_uik_usarmy_d"",200],[""rhsusf_M1232_MC_M2_usmc_d"",300],[""rhsusf_CGRCAT1A2_M2_usmc_d"",225],[""B_MRAP_01_F"",225],[""B_MRAP_01_hmg_F"",275],[""B_LSV_01_unarmed_F"",125],[""B_LSV_01_armed_F"",175],[""B_LSV_02_unarmed_F_custom_recon"",125],[""B_LSV_02_armed_F_custom_recon"",175],[""B_LSV_02_AT_F_custom_recon"",225],[""B_Quadbike_01_F"",50],[""B_Truck_01_transport_F"",250],[""B_APC_Tracked_01_AA_F"",400]]";
force TAW_VehicleSpawner_Debug = false;
force TAW_VehicleSpawner_Enabled = false;
force TAW_VehicleSpawner_Drone_List = "[[""rksla3_uav_mq9_reaper_generic"",300],[""USAF_MQ9"",300],[""USAF_RQ4A"",200],[""B_T_UAV_03_dynamicLoadout_F_mk2"",400],[""B_UAV_05_F_mk2"",400],[""B_UAV_02_dynamicLoadout_F_mk2"",400],[""B_UGV_01_rcws_F"",125],[""GX_B_MQ8B_UAV_RECON"",125],[""GX_B_MQ8B_UAV_RECON_SEATED"",150],[""GX_B_MQ8B_UAV_ARMED"",200],[""GX_B_RWS_DEFNDER_MEDIUM"",75],[""GX_B_THEMIS_UGV_CARGO"",100],[""GX_B_THEMIS_UGV_HUNTER_LAUNCHER"",125],[""GX_B_THEMIS_UGV_DEFNDER_MEDIUM"",125]]";
...
force TAW_GEAR_RESTRICTION_Ammobearer_Items = "[""taw_aux_customs_backpack_carryall_nfp_t"",""taw_aux_customs_backpack_carryall_flecktarn"",""taw_aux_customs_backpack_carryall_marpat_d"",""taw_aux_customs_backpack_carryall_m05_snow"",""taw_aux_customs_backpack_carryall_BLK"",""taw_aux_customs_backpack_carryall_OLI"",""taw_aux_customs_backpack_carryall_SND""]";
force TAW_GEAR_RESTRICTION_AT_Weapons = "[""launch_RPG32_F"", ""launch_RPG32_ghex_F"", ""launch_RPG32_NATO"", ""launch_RPG7_F"", ""launch_I_Titan_F"", ""launch_O_Titan_ghex_F"", ""launch_O_Titan_F"", ""launch_B_Titan_F"", ""launch_B_Titan_tna_F"", ""launch_O_Titan_short_F"", ""launch_O_Titan_short_ghex_F"", ""launch_I_Titan_short_F"", ""launch_B_Titan_short_F"", ""launch_B_Titan_short_tna_F"", ""launch_O_Titan_short_ghex_F"", ""rhs_weap_fgm148"", ""rhs_weap_smaw"", ""rhs_weap_smaw_green"", ""rhs_weap_rpg7"", ""rhs_weap_maaws"", ""launch_MRAWS_green_F"", ""launch_MRAWS_olive_F"", ""launch_MRAWS_sand_F"", ""launch_O_Vorona_brown_F"", ""launch_O_Verona_green_F"", ""launch_O_Vorona_black_F"", ""JCA_launch_Mk153_black_F"", ""JCA_launch_Mk153_olive_F"", ""JCA_launch_Mk153_sand_F"", ""JCA_launch_Mk153_PWS_black_F"", ""JCA_launch_Mk153_PWS_olive_F"", ""JCA_launch_Mk153_PWS_sand_F"", ""launch_MRAWS_black_F"", ""launch_MRAWS_green_rail_F"", ""launch_MRAWS_olive_rail_F"", ""launch_MRAWS_sand_rail_F""]";
...
force TAW_GEAR_RESTRICTION_Rifleman_Weapons = "[""arifle_SLR_V_lxWS"",""lot_SCAR_short_grip_black_F"",""lot_SCAR_short_grip_khaki_F"",""lot_SCAR_short_grip_F"",""lot_SCAR_grip_black_F"",""lot_SCAR_grip_khaki_F"",""lot_SCAR_grip_F"",""lot_SCAR_GL_black_F"",""lot_SCAR_GL_khaki_F"",""lot_SCAR_GL_F"",""srifle_DMR_06_olive_F"",""srifle_DMR_06_camo_F"",""srifle_DMR_06_hunter_F"",""rhs_weap_m14"",""rhs_weap_m14_d"",""rhs_weap_m14_fiberglass"",""rhs_weap_m14_wd"",""rhs_weap_m14_ris_d"",""rhs_weap_m14_ris_wd"",""rhs_weap_m14_ris_fiberglass"",""rhs_weap_m14_ris"",""rhs_weap_m14_rail_d"",""rhs_weap_m14_rail_wd"",""rhs_weap_m14_rail"",""rhs_weap_m14_rail_fiberglass"",""arifle_MXM_khk_F"",""arifle_MXM_Black_F"",""arifle_MXM_F"",""rhs_weap_m14ebrri"",""JCA_arifle_SCAR_H_black_F"",""JCA_arifle_SCAR_H_olive_F"",""JCA_arifle_SCAR_H_sand_F"",""JCA_arifle_SCAR_H_short_black_F"",""JCA_arifle_SCAR_H_short_olive_F"",""JCA_arifle_SCAR_H_short_sand_F""]";
force TAW_GEAR_RESTRICTION_Support_Items = "[""TFAR_anprc163""]";
force TAW_GEAR_RESTRICTION_Medic_Items = "[""taw_aux_medical_DeployableMedicalBag"",""taw_aux_customs_backpack_kitbag_nfp_t"",""taw_aux_customs_backpack_kitbag_flecktarn"",""taw_aux_customs_backpack_kitbag_marpat_d"",""taw_aux_customs_backpack_kitbag_m05_snow"",""taw_aux_customs_backpack_kitbag_BLK"",""taw_aux_customs_backpack_kitbag_OLI"",""taw_aux_customs_backpack_kitbag_SND"",""taw_aux_customs_backpack_kitbag_medic_nfp_t"",""taw_aux_customs_backpack_kitbag_medic_flecktarn"",""taw_aux_customs_backpack_kitbag_medic_marpat_d"",""taw_aux_customs_backpack_kitbag_medic_m05_snow"",""taw_aux_customs_backpack_kitbag_medic_BLK"",""taw_aux_customs_backpack_kitbag_medic_OLI"",""taw_aux_customs_backpack_kitbag_medic_SND""]";
...
force tsp_cba_radio_preference_Others = "Vest";
...
// VMS
force vms_cat_air_drones = "rksla3_uav_mq9_reaper_generic,300,MQ-9A Reaper,B_UAV_AI|USAF_MQ9,300,MQ-9 Reaper,B_UAV_AI|USAF_RQ4A,200,RQ-4A Global Hawk,B_UAV_AI|B_T_UAV_03_dynamicLoadout_F_mk2,400,MQ-12 Falcon,B_UAV_AI|B_UAV_05_F_mk2,400,UCAV Sentinel,B_UAV_AI|B_UAV_02_dynamicLoadout_F_mk2,400,MQ-4A Greyhawk,B_UAV_AI|B_UGV_01_rcws_F,125,UGV Stomper (RCWS),B_UAV_AI|GX_B_MQ8B_UAV_RECON,125,MQ-8B Fire Scout (Recon),B_UAV_AI|GX_B_MQ8B_UAV_RECON_SEATED,150,MQ-8B Fire Scout (Recon Seated),B_UAV_AI|GX_B_MQ8B_UAV_ARMED,200,MQ-8B Fire Scout (Armed),B_UAV_AI|GX_B_RWS_DEFNDER_MEDIUM,75,RWS Defender (Medium),B_UAV_AI|GX_B_THEMIS_UGV_CARGO,100,THeMIS UGV (Cargo),B_UAV_AI|GX_B_THEMIS_UGV_HUNTER_LAUNCHER,125,THeMIS UGV (Hunter Launcher),B_UAV_AI|GX_B_THEMIS_UGV_DEFNDER_MEDIUM,125,THeMIS UGV (Defender Medium),B_UAV_AI";
force vms_cat_air_helis = "RHS_UH60M_d,225|B_Heli_Transport_01_F,200|Heli_Transport_01_pylons_laser_base_mk2,250|B_CTRG_Heli_Transport_01_DAP_F,250|RHS_MELB_MH6M,175|RHS_MELB_AH6M,275|RHS_MELB_AH6M_MK2,275|RHS_UH1Y,200|rhsusf_CH53E_USMC,350|TF373_SOAR_MH47G,300|B_Heli_Transport_03_F,300|RHS_AH64D,600|O_Heli_Attack_02_dynamicLoadout_F,600|B_Heli_Attack_01_pylons_dynamicLoadout_F,400|RHS_AH1Z,450|Valor_Turret_Transport_CrewGun_F,350|Valor_Attack_F,400|Valor_Transport_Armed_F,275|B_Heli_Transport_04_F,200";
force vms_cat_air_planes = "B_Plane_Fighter_01_F,500|FIR_AV8B,500|RHSGREF_A29B_HIDF,300|USAF_A10,600|JS_JC_FA18E,525|JS_JC_FA18F,525|USAF_F22,550|USAF_F35A,650|FIR_F16C,550|FIR_F16D,575|ua_haf_jas_39,450|rhs_l159_cdf_b_CDF,350|JK_B_US_C5M_Super_Galaxy_F,700|JK_B_US_C5B_Galaxy_F,600|USAF_C130J,600|STmod_airplane_AC130J,700|STmod_airplane_MC130J,600|STmod_airplane_MC130J_VIV,600|B_T_VTOL_02_infantry_dynamicLoadout_F,500|B_T_VTOL_02_vehicle_dynamicLoadout_F,500|B_T_VTOL_02_medical_dynamicLoadout_F,300|B_T_VTOL_01_infantry_F,250|B_T_VTOL_01_vehicle_F,250|B_T_VTOL_01_armed_F,400";
force vms_cat_land_heavy = "B_APC_Tracked_01_AA_F,400";
force vms_cat_land_light = "rhsusf_m1151_m2_v1_usarmy_d,175|rhsusf_m1240a1_m240_uik_usarmy_d,200|B_MRAP_01_F,225|B_MRAP_01_hmg_F,275|B_LSV_01_unarmed_F,125|B_LSV_01_armed_F,175|B_LSV_02_unarmed_F_custom_recon,125|B_LSV_02_armed_F_custom_recon,175|B_LSV_02_AT_F_custom_recon,225|B_Quadbike_01_F,50";
force vms_cat_land_medium = "rhsusf_M1232_MC_M2_usmc_d,300|rhsusf_CGRCAT1A2_M2_usmc_d,225|B_Truck_01_transport_F,250|B_Truck_01_FOB_F,800|B_Truck_01_fuel_F,250|B_Truck_01_ammo_F,250|B_Truck_01_flatbed_F,100";
force vms_cat_land_misc = "B_Slingload_01_FOB_F,800|B_Slingload_01_Medevac_F,250|TAW_Resupply_ACEArsenal,50|Land_Pod_Heli_Transport_04_bench_black_F,50|Land_Pod_Heli_Transport_04_covered_black_F,75|Land_Pod_Heli_Transport_04_medevac_black_F,75|Land_Pod_Heli_Transport_04_fuel_black_F,200|Land_Pod_Heli_Transport_04_repair_black_F,200|Land_Pod_Heli_Transport_04_ammo_black_F,200";
force vms_cat_land_static = "B_SAM_System_01_F,300|B_SAM_System_03_F,250|B_Radar_System_01_F,250|CRAM_AAA_System_01_base_F,250|RHS_Stinger_AA_pod_D,100|E22_B_JC_N_SAM_system_01_F,300|E22_B_JC_N_AAA_System_01_F,250|E22_B_JC_N_Radar_system_01_F,250";
force vms_cat_sea = "B_Boat_Transport_01_F,100|B_Boat_Armed_01_minigun_F,200|rhsusf_mkvsoc,400|B_SDV_01_F,100";
force vms_config_cb_veh_filter_enabled = false;
...
force vms_config_rearm_time_per_mag = 5;
force vms_config_refuel_enabled = true;
force vms_config_refuel_time_per_pct = 1;
force vms_config_repair_enabled = true;
force vms_config_repair_time_per_pct = 1;
force vms_config_service_max_time = 45;
force vms_config_vehicleshop_enabled = true;
force vms_config_vs_economy_enabled = true;
force vms_config_vs_economy_side_mode = 0;
force vms_config_vs_interact_range = 2.05;
force vms_config_vs_price_multiplier = 1;
force vms_config_vs_spawn_class_air = "TAW_Terminal_Air_Spawn";
force vms_config_vs_spawn_class_land = "TAW_Terminal_Car_Spawn";
force vms_config_vs_spawn_class_sea = "TAW_Terminal_Boat_Spawn";
force vms_config_vs_spawn_protection = 5;
force vms_config_vs_terminal_class = "TAW_Terminal_Vehicle_Laptop";
force vms_config_yield_to_apcs = true;
force vms_lists_free_turret_mags = "SmokeLauncherMag,60Rnd_CMFlare_Chaff_Magazine,120Rnd_CMFlare_Chaff_Magazine,168Rnd_CMFlare_Chaff_Magazine,240Rnd_CMFlare_Chaff_Magazine,300Rnd_CMFlare_Chaff_Magazine,192Rnd_CMFlare_Chaff_Magazine";
force vms_lists_rearm_sources = "";
force vms_lists_refuel_sources = "";
force vms_lists_repair_sources = "";
force vms_modfilter_a3_weapons_f = true;
force vms_modfilter_a3_weapons_f_jets = true;
force vms_modfilter_a3_weapons_f_orange = true;
force vms_modfilter_ace_compat_rhs_afrf3_hearing = true;
force vms_modfilter_air_1_f_lxws = true;
force vms_modfilter_fir_airweaponsystem_us = true;
force vms_modfilter_fsnb_freestyles_nuclear_bombs = true;
force vms_modfilter_gx_drones_compat_ace = true;
force vms_modfilter_kat_chemical = true;
force vms_modfilter_pracs_opfor_weapons = true;
force vms_modfilter_rhs_c_airweapons = true;
force vms_modfilter_rhsgref_c_airweapons = true;
force vms_modfilter_rhsusf_c_airweapons = true;
force vms_modfilter_rksla3_cvwp = true;
force vms_modfilter_rksla3_mq9 = true;
force vms_modfilter_stmod_airplane_ac130j = true;
force vms_modfilter_taw_aux_balance_rhs = true;
force vms_roles_zeus_uids = "";
force vms_vehfilter_a3_air_f_beta_heli_attack_02 = true;
force vms_vehfilter_a3_air_f_enoch_uav_01 = true;
force vms_vehfilter_a3_air_f_exp_heli_transport_01 = true;
force vms_vehfilter_a3_air_f_heli_heli_transport_04 = true;
force vms_vehfilter_a3_air_f_jets_plane_fighter_01 = true;
force vms_vehfilter_a3_air_f_orange_uav_06 = true;
force vms_vehfilter_a3_soft_f_kart_kart_01 = true;
force vms_vehfilter_a3_static_f_mark_designator_01 = true;
force vms_vehfilter_ace_cargo = true;
force vms_vehfilter_air_1_f_lxws = true;
force vms_vehfilter_brdmfix = true;
force vms_vehfilter_cba_ai = true;
force vms_vehfilter_cdf_f16mod_f = true;
force vms_vehfilter_cup_ca_config = true;
force vms_vehfilter_d37_cram = true;
force vms_vehfilter_emp_greystone_pmc_blufor_faction = true;
force vms_vehfilter_fir_av8b_f = true;
force vms_vehfilter_fir_ddglibertyupgrade_f = true;
force vms_vehfilter_go_skins_winter = true;
force vms_vehfilter_gx_blanco_cartel = true;
force vms_vehfilter_gx_drones_rws_defnder = true;
force vms_vehfilter_ibr_yulakian_weapons = true;
force vms_vehfilter_jk_us_air_f_c5m_galaxy = true;
force vms_vehfilter_kat_compat_rhs_usf3 = true;
force vms_vehfilter_lk_shahed = true;
force vms_vehfilter_peral_lcac = true;
force vms_vehfilter_pike_drones = true;
force vms_vehfilter_pracs_sla = true;
force vms_vehfilter_rhs_c_2s1 = true;
force vms_vehfilter_rhs_us_a2_airimport = true;
force vms_vehfilter_rhsgref_c_a2port_armor = true;
force vms_vehfilter_rhssaf_c_vehicles = true;
force vms_vehfilter_rksla3_mq9 = true;
force vms_vehfilter_static_f_ia_spottingscope_01 = true;
force vms_vehfilter_static_f_jca_ls_aaa_system_01 = true;
force vms_vehfilter_stmod_airplane_ac130j = true;
force vms_vehfilter_taw_aux_balance = true;
force vms_vehfilter_tf373_soar_chinooks = true;
force vms_vehfilter_tfar_core = true;
force vms_vehfilter_vtf_kf_vehicles = true;
force vms_config_vs_heli_pretick = true;
force vms_config_vs_heli_min_cargo = 6;
...
force zhc_offload_CheckDelay = 10;
force zhc_offload_CycleDelay = 10;
...
force zhc_offload_OffloadDelay = 10;
force zhc_offload_RebalanceDelay = 120;
